...
- (void)testContentBodyToJSON {
    ...
    XCTAssertEqualObjects(JSON[JiveContentBodyAttributes.text], self.contentBody.text, @"Wrong text.");
    XCTAssertEqualObjects(JSON[JiveContentBodyAttributes.type], self.contentBody.type, @"Wrong type.");
    XCTAssertEqualObjects(JSON[JiveContentBodyAttributes.editable], self.contentBody.editable, @"Wrong editable");
}
...
- (void)testEditableValue {
    XCTAssertFalse(self.contentBody.editableValue, @"Wrong initial value");
    
    [self.contentBody setValue:@YES forKey:JiveContentBodyAttributes.editable];
    XCTAssertTrue(self.contentBody.editableValue, @"Failed to change with real value");
    
    [self.contentBody setValue:@NO forKey:JiveContentBodyAttributes.editable];
    XCTAssertFalse(self.contentBody.editableValue, @"Failed to change with updated value");
}
